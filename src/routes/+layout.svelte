...
<nav class='navbar is-dark is-transparent'>
  ...
  <div
    class='navbar-menu'
    class:is-active={isOpen}
    class:mobile-menu={isOpen}
    class:desktop-menu={!isOpen}
    transition:slide|local={{ duration: 200 }}
  >
    <div class='navbar-start'>
      <a class='navbar-item' class:is-active={$page.url.pathname === '/'} href='/'> Home </a>
      {#if user}
        <a class='navbar-item' class:is-active={$page.url.pathname === '/images'} href='/images'> Images </a>
      {/if}
    </div>
      ...
      <div class='navbar-item'>
        ...
        {:else}
          <div class='field is-grouped auth-buttons'>
            ...
            <p class='control'>
              <a class='button is-primary' class:is-active={$page.url.pathname === '/signup'} href='/signup'>
                <span>Sign up</span>
              </a>
            </p>
          </div>
